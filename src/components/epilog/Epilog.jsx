    ...
    <div className="footer-container">
      <div className="padding-container">
        ...
        <div>
          <div>
            ...
            <p>
              ...
              track their seizures and other epilepsy-related symptoms. 
            </p>
          </div>
          <div>
            <h1>Role</h1>
        ...
        <div>
          <h1>Problem Space</h1>
          <p>
            Epilepsy is a neurological disorder that often results in seizures and other 
            long-lasting symptoms. Common treatments for epilepsy include medication, diets, 
            and surgery. All people with epilepsy must be constantly alert for anything that 
